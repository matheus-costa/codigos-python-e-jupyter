...
#template é usado para ajudar o python a encontrar os arquivos
app = Flask(__name__, template_folder='.')

#rota que o usuário vai acessar + método que vai ser usado nesta função
#método GET envia dados pela URL
